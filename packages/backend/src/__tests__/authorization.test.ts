...
function makeApp(callerId: string) {
  ...
  const repo = {
    ...
    recordWeight: async () => {},
    listWeight: async () => [],
    recordKickSession: async () => {},
    listKickSessions: async () => [],
    recordContractionSession: async () => {},
    listContractionSessions: async () => [],
    listMedications: async () => [],
    upsertMedication: async () => {},
    medicationOwner: async () => null,
