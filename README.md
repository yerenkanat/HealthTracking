...
app/tool/verify_*.dart               36 dependency-free conformance runners (968 assertions)
...
```bash
# Pure-Dart logic (no Flutter SDK needed) — 36 runners, 968 assertions:
cd app
...
| Layer | Result |
|-------|--------|
| Dart pure logic (36 `verify_*` runners) | **968 assertions ✅** |
