...
app/tool/verify_*.dart               35 dependency-free conformance runners (966 assertions)
...
```bash
# Pure-Dart logic (no Flutter SDK needed) — 35 runners, 966 assertions:
cd app
...
flutter test                          # 263 widget/unit tests
