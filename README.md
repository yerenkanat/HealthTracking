...
app/tool/verify_*.dart               36 dependency-free conformance runners (989 assertions)
...
```bash
# Pure-Dart logic (no Flutter SDK needed) — 36 runners, 989 assertions:
cd app
...
flutter test                          # 264 widget/unit tests
...
| Layer | Result |
|-------|--------|
| Dart pure logic (36 `verify_*` runners) | **989 assertions ✅** |
