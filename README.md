...
app/tool/verify_*.dart               34 dependency-free conformance runners (884 assertions)
...
```bash
# Pure-Dart logic (no Flutter SDK needed) — 34 runners, 884 assertions:
cd app
...
flutter test                          # 228 widget/unit tests
...
| Layer | Result |
|-------|--------|
| Dart pure logic (34 `verify_*` runners) | **884 assertions ✅** |
| Flutter widget + unit tests | **228 ✅** |
| `flutter analyze` | clean ✅ |
