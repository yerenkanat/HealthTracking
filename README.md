...
app/tool/verify_*.dart               36 dependency-free conformance runners (979 assertions)
...
```bash
# Pure-Dart logic (no Flutter SDK needed) — 36 runners, 979 assertions:
cd app
...
| Layer | Result |
|-------|--------|
| Dart pure logic (36 `verify_*` runners) | **979 assertions ✅** |
