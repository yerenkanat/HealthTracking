...
const Map<String, Map<AppLocale, String>> _catalog = {
  ...
  'vitals_scan_camera': {AppLocale.ru: 'Камера', AppLocale.kk: 'Камера', AppLocale.en: 'Camera'},
  'vitals_scan_gallery': {AppLocale.ru: 'Из галереи', AppLocale.kk: 'Галереядан', AppLocale.en: 'From gallery'},
  'vitals_scanning': {AppLocale.ru: 'Распознаём…', AppLocale.kk: 'Танып жатырмыз…', AppLocale.en: 'Reading…'},
  'vitals_scan_filled': {AppLocale.ru: 'Проверьте распознанные значения и сохраните', AppLocale.kk: 'Танылған мәндерді тексеріп, сақтаңыз', AppLocale.en: 'Check the recognised values and save'},
  'vitals_scan_none': {AppLocale.ru: 'Не удалось распознать значения — введите вручную', AppLocale.kk: 'Мәндерді тани алмадық — қолмен енгізіңіз', AppLocale.en: 'Couldn\'t read any values — enter them by hand'},
  'vitals_scan_error': {AppLocale.ru: 'Не удалось обработать фото. Попробуйте ещё раз.', AppLocale.kk: 'Фотоны өңдеу мүмкін болмады. Қайталап көріңіз.', AppLocale.en: 'Couldn\'t process the photo. Please try again.'},
