        ...
        children: [
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                // Screen 15a's care list is NOT reached from here any more: it
                // is the «Сегодня» segment of this tab (child_hub_screen.dart),
                // one tap away in the control directly above this map. A
                // floating button to a destination that is already a segment
                // would be the second entry to one place on one screen.
