...
void main() {
  ...
  _chk('week 27 → third trimester', currentMilestone(27).code == 'MS_THIRD_TRIMESTER');
  ...
  _chk('next after week 20 = third trimester in 7', nextMilestone(20)?.code == 'MS_THIRD_TRIMESTER' && weeksUntil(20, nextMilestone(20)!) == 7);
